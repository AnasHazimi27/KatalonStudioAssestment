...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Skills'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Add'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus'), skillName)

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/textarea_Description_oxd-textarea oxd-texta_fed1e5'), skillDesc)
