...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/i_British Computer Society (BCS)_oxd-icon b_0e9052'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus'), 'Malaysia Computer Society (MCS)')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Save'))

WebUI.rightClick(findTestObject('Object Repository/Page_OrangeHRM/div_SuccessSuccessfully Updated'))
