...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus oxd-i_ad7396'), 'Automation Tester 3')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_OrangeHRM/span_Already exists (1)'), 0)
