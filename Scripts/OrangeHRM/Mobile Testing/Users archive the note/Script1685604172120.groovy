...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Hello (1)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.ImageButton (7)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Archive'), 0)
